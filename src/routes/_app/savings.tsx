        ...
        {rows.map((g) => {
          ...
          return (
            <div key={g.id} className="rounded-2xl border border-border bg-card p-5">
              ...
              <div className="mt-2 flex items-center justify-between text-sm"><span>{formatMoney(g.current_amount)}</span><span className="text-muted-foreground">of {formatMoney(g.target_amount)}</span></div>
